...
parser.add_argument('--output',           default='./output/HH_bior',        help='Output folder.')
parser.add_argument('--dataset',          default='./data/HED-BSDS/HH_bior', help='HED-BSDS dataset folder.')
# 5. Others.
