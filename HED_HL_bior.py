...
parser.add_argument('--output',           default='./output/HL_bior',        help='Output folder.')
parser.add_argument('--dataset',          default='./data/HED-BSDS/HL_bior', help='HED-BSDS dataset folder.')
# 5. Others.
