...
parser.add_argument('--output',           default='./output/LH_bior',        help='Output folder.')
parser.add_argument('--dataset',          default='./data/HED-BSDS/LH_bior', help='HED-BSDS dataset folder.')
# 5. Others.
